-- CreateEnum
CREATE TYPE "PaymentStatus" AS ENUM ('RESERVED', 'PAID', 'REFUSED');
...
-- AddForeignKey
ALTER TABLE "Payment" ADD CONSTRAINT "Payment_historicId_fkey" FOREIGN KEY ("historicId") REFERENCES "Historic"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
